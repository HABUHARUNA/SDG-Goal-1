...
<div class="hero3"> 
  ...
  <h3 style="text-align: center; padding: 15px 0px 10px 0px;">Volunteer Post</h3> 
 
  <div>
    <form action=" {{Route('volunteer.post')}}" method="POST"  class="contactform" enctype="multipart/form-data">
          @csrf
      ...
      <textarea name="body" id="" cols="100" rows="7"></textarea> <br> <br>
